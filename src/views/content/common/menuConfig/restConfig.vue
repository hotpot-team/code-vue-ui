    ...
    <div class="rest-config">
        <Tabs type="card" v-model="currentTab">
            <TabPane :label="configMenuName" :name="configMenuName">
                <table-form-config v-if="showConfig" :config="config" :menuId="configMenuId" :schema="configMenuPath" :configMenuName="configMenuName" @saveConfig="saveConfig" @addRelationTab="addRelationTab"></table-form-config>
            </TabPane>
        ...
        methods: {
            ...
            saveConfig(config) {
                if (!this.config || !this.config.id) {
                    this.config = {};
                    this.config.id = this.configMenuId + "_" + this.configMenuName;
                ...
                this.uiConfigData[this.configMenuId] = this.config;
